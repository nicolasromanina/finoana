...
const mg: Translations = {
  ...
  productivityScore: 'Tahan\'ny vokatra',
  weeklyPerformance: 'Fahombiazana herinandro',
  excellent: 'Tsara be',
  good: 'Tsara',
  fair: 'Salama',
  ...
  averageSession: 'Salanisan\'ny fotoana',
  peakHours: 'Ora be mpampiasana',
  consistency: 'Faharetana',
